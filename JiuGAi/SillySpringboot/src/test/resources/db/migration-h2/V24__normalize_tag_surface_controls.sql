ALTER TABLE app_tag_library ALTER COLUMN discover_visible TINYINT NOT NULL DEFAULT 1;
ALTER TABLE app_tag_library ALTER COLUMN discover_recommended TINYINT NOT NULL DEFAULT 0;
ALTER TABLE app_tag_library ALTER COLUMN detail_visible TINYINT NOT NULL DEFAULT 1;
