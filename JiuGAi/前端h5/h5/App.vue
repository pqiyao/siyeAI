	...
	export default {
		onLaunch: function() {
			...
			Vue.prototype.languageChange=function(){
				...
				const merged = { ...base };
				// 酒馆页：无模块时整段回退；有模块时与 zh-cn/en 浅合并，补全新增 key
...
<style>
	...
	uni-tabbar {
		border-top: 1px solid rgba(78, 99, 115, 0.12) !important;
		box-shadow: 0 -8px 24px rgba(38, 57, 77, 0.08);
	}
	/* Light clover tavern common shell for legacy pages that still use dark local classes. */
	...
	.card-disc {
		...
		border-color: rgba(78, 99, 115, 0.14) !important;
		box-shadow: 0 18rpx 40rpx rgba(38, 57, 77, 0.1) !important;
		color: #26394d !important;
	}
	input,
	textarea,
	...
	.lang-chip {
		...
		color: #fff !important;
		box-shadow: 0 14rpx 30rpx rgba(48, 103, 117, 0.18) !important;
	}
	.head-title,
	.section-title,
	.card-title,
