...
function getTermsSections() {
	return [
		...
		{
			title: '用户内容与责任',
			body: '本项目为非商用 AI 角色扮演娱乐项目，仅提供角色创建、导入、聊天、生成、展示等工具和体验服务。用户自行创建、上传、导入、编辑、生成、保存、使用或分享的角色卡、头像、图片、提示词、世界设定、聊天内容及其他内容，均由用户自行负责。用户应确保相关内容和使用行为不违反法律法规、公序良俗及第三方合法权益。平台不主动代表、认可、背书或承诺用户内容的真实性、合法性、准确性和适当性。因用户内容或用户使用行为引发的争议、投诉、侵权、违法违规责任，由用户依法自行承担；平台有权根据合规、安全和运营需要，对相关内容采取限制展示、隐藏、删除、封禁账号、限制功能、保存必要记录或配合处理等措施。'
		},
		{
			title: 'AI 生成内容提示',
