		...
		submit() {
			...
			this.util
				...
				.then((res) => {
					...
					const u = uni.getStorageSync('user') || {};
					u.nickname = profile.nickname || name;
					u.avatar = profile.avatar || avatar;
					u.need_edit = profile.need_edit == null ? 1 : profile.need_edit;
...
/* Light clover tavern perfect-profile refresh. */
.intro-card,
.avatar-card,
.field-card,
.tips-card {
	...
	box-shadow: 0 24rpx 56rpx rgba(67, 112, 142, 0.12);
...
.avatar-preview {
	...
	box-shadow: 0 20rpx 48rpx rgba(67, 112, 142, 0.14);
}
...
.btn-primary {
	...
	box-shadow: 0 20rpx 40rpx rgba(52, 143, 184, 0.18);
}
</style>
