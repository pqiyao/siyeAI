...
public class DefaultStAdapter implements StAdapter {
    ...
    public List<java.util.Map<String, String>> buildRuntimeMessages(
        ...
        return buildRuntimeMessages(avatarUrl, fileName, userName, charName, groupNames, worldNames, null);
    }
    ...
    public List<java.util.Map<String, String>> buildRuntimeMessages(
        ...
        return stClient.runtimeChatBuildMessages(avatarUrl, fileName, userName, charName, groupNames, worldNames, runtimePresetBundle);
    }
