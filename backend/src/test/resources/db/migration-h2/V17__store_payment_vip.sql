ALTER TABLE app_h5_user_profile_ext ADD COLUMN IF NOT EXISTS vip_expires_at TIMESTAMP NULL;

ALTER TABLE app_h5_user_profile_ext ADD COLUMN IF NOT EXISTS daily_chat_quota INT NOT NULL DEFAULT 0;

ALTER TABLE app_h5_user_profile_ext ADD COLUMN IF NOT EXISTS daily_image_quota INT NOT NULL DEFAULT 0;
