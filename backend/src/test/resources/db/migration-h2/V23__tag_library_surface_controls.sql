ALTER TABLE app_tag_library ADD COLUMN IF NOT EXISTS discover_visible TINYINT NOT NULL DEFAULT 1;

ALTER TABLE app_tag_library ADD COLUMN IF NOT EXISTS discover_recommended TINYINT NOT NULL DEFAULT 0;

ALTER TABLE app_tag_library ADD COLUMN IF NOT EXISTS detail_visible TINYINT NOT NULL DEFAULT 1;
