...
var OFFICIAL_QQ_GROUP = '3956835038';
...
function getTermsSections() {
	return [
		{
			title: '项目定位',
			body: 'AI Character Chat 为 AI 角色扮演纯娱乐分享项目，当前非商用，不支持充值、在线支付或付费开通。页面中的会员、余额、权益等内容仅作为体验和功能展示，不构成实际交易服务。'
		},
		{
			title: '服务性质',
		...
		{
			title: '联系与反馈',
			body: '如需体验协助、问题反馈或内容处理，请联系 QQ：' + OFFICIAL_QQ_GROUP + '。'
		}
	];
}
...
function getPrivacySections() {
	return [
		...
		{
			title: '数据保存与删除',
			body: '平台会在实现服务目的所需期限内保存数据。用户如需删除账号或处理个人数据，可通过联系 QQ 协助处理。'
		},
		{
			title: '安全措施',
		...
		{
			title: '未成年人保护',
			body: '本项目不面向未成年人提供服务。若发现未成年人使用，建议立即停止访问；如监护人需要协助处理相关数据，可联系 QQ。'
		},
		{
			title: '联系方式',
			body: '联系 QQ：' + OFFICIAL_QQ_GROUP + '。如有隐私、内容合规、账号或数据删除问题，可通过该渠道联系。'
		}
	];
}
