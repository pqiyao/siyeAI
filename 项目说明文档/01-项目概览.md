...
当前运营中的 H5 用户端可以访问：[https://siyeai.pengqiyao.cn/](https://siyeai.pengqiyao.cn/)。

本仓库是项目完整开源版本，线上站点可能使用了与本地 Docker 默认配置不同的生产配置。欢迎先体验，再按文档本地部署或二次开发；如果项目对你有帮助，也欢迎点一个免费的 Star。
